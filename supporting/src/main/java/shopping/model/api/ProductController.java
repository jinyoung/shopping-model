...
public class ProductController {
  ...
  @RequestMapping(value = "/product/registerProduct",
        method = RequestMethod.POST,
        produces = "application/json;charset=UTF-8")
  public void registerProduct(@RequestBody RegisterProductCommand registerProductCommand)
        throws Exception {
      System.out.println("##### /product/registerProduct  called #####");

      // send command
      commandGateway.send(registerProductCommand);
  }
